...
func usage(w io.Writer) {
	...
	fmt.Fprintf(w, "  trace <file.k>           run a file with the CLI debugger\n")
	fmt.Fprintf(w, "  trace dap                run DAP debugger server over stdio\n")
	fmt.Fprintf(w, "  debug <file.k>           debugger alias (deprecated)\n")
